 ...
 * Single Page Application with embedded page content
 */
      ...
      <section class="min-h-[calc(100vh-8rem)] flex flex-col justify-center py-12 md:py-0">
        <div class="max-w-2xl">
          ...
          <h1 class="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-[1.1] mb-6 animate-fade-in">
            Halo, Saya <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500">Hakkull</span>
            <br />
          ...
          <div class="h-8 mb-8">
            <p class="text-lg sm:text-xl text-slate-500 dark:text-slate-400">
              Saya membangun <span class="text-blue-500 font-semibold" id="typing-text"></span><span class="border-r-2 border-blue-500 animate-blink" id="typing-cursor">|</span>
            </p>
          </div>
        ...
        <div class="grid md:grid-cols-2 gap-6">
          <div class="card-gradient-blue p-8 rounded-2xl relative overflow-hidden group cursor-pointer" onclick="switchPage('projects')">
            <div class="relative z-10">
              <h3 class="text-2xl font-bold mb-2 text-white">Lihat Proyek</h3>
              <p class="text-blue-100/80 mb-6 text-sm">Jelajahi proyek Python yang telah saya bangun.</p>
          ...
          <div class="p-8 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex flex-col justify-between hover:shadow-lg transition-all">
            <div>
              <h3 class="text-2xl font-bold mb-2 text-blue-500">Mari Terhubung</h3>
              <p class="text-slate-500 dark:text-slate-400 text-sm mb-6">Tertarik berkolaborasi? Hubungi saya melalui WhatsApp atau Email.</p>
            </div>
          ...
          <div class="lg:col-span-2 space-y-6">
            <div>
              <p class="text-lg leading-relaxed text-slate-600 dark:text-slate-300">
                Saya adalah seorang <span class="text-blue-500 font-bold">Junior Backend Developer</span> yang bersemangat dalam membangun logika server yang efisien. Berfokus pada Python untuk menciptakan solusi yang handal. Terbiasa dengan environment Linux dan version control menggunakan Git & GitHub.
              </p>
            </div>
    ...
    resume: `<div class="py-8 md:py-12">
        <div class="mb-12">
          ...
          <div class="flex flex-wrap items-center gap-2 text-slate-500 dark:text-slate-400">
            <span class="px-3 py-1 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-xs font-bold">Backend Developer</span>
            <span class="text-slate-300 dark:text-slate-700">•</span>
            ...
            <span class="text-slate-300 dark:text-slate-700">•</span>
            <span class="px-3 py-1 rounded-full bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 text-xs font-bold">Python Developer</span>
          </div>
        </div>
        ...
        <div class="space-y-8 max-w-4xl">
          ...
          <section class="resume-section">
            ...
            <p class="text-slate-600 dark:text-slate-400 leading-relaxed pl-[3.25rem]">
              Seorang Backend Developer yang berdedikasi tinggi dalam membangun struktur server yang efisien. Memiliki pemahaman kuat tentang konsep MVC, database relasional, dan integrasi API. Terbiasa dengan lingkungan Linux dan pengelolaan kode menggunakan Git & GitHub.
            </p>
          </section>
          ...
          <section class="resume-section">
            <div class="flex items-center gap-3 mb-4">
              ...
              <h2 class="text-xl font-bold">Keahlian Teknis</h2>
            </div>
          ...
          <section class="resume-section">
            ...
            <div class="relative pl-[3.25rem]">
              ...
              <div class="timeline-item relative pb-12 last:pb-0">
                ...
                <div class="ml-6">
                  <div class="flex flex-wrap items-center gap-2 mb-1">
                    <h3 class="text-lg font-bold">Proyek Pribadi & Pembelajaran</h3>
                    <span class="px-2.5 py-0.5 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-[10px] font-bold uppercase tracking-wider">2025 — Sekarang</span>
                  </div>
                  <ul class="space-y-2 text-slate-600 dark:text-slate-400 text-sm mt-3">
                    <li class="flex items-start gap-2">
                      ...
                      Membangun aplikasi CRUD dengan arsitektur MVC menggunakan Python.
                    </li>
                    <li class="flex items-start gap-2">
                      <i class="fas fa-chevron-right text-blue-500 mt-0.5 text-xs"></i>
                      Mengembangkan aplikasi desktop Python untuk deteksi objek real-time.
                    </li>
                    <li class="flex items-start gap-2">
                      <i class="fas fa-chevron-right text-blue-500 mt-0.5 text-xs"></i>
                      Mendesain dan mengelola database relasional untuk berbagai aplikasi.
                    </li>
                    <li class="flex items-start gap-2">
                      <i class="fas fa-chevron-right text-blue-500 mt-0.5 text-xs"></i>
              ...
              <div class="timeline-item relative pb-12 last:pb-0">
                <div class="absolute -left-[1.625rem] top-1 w-4 h-4 rounded-full bg-emerald-500 ring-4 ring-white dark:ring-slate-900 shadow-sm"></div>
                <div class="ml-6">
                  <div class="flex flex-wrap items-center gap-2 mb-1">
                    <h3 class="text-lg font-bold">Universitas Yudharta Pasuruan</h3>
            ...
            <div class="p-6 rounded-2xl border-2 border-dashed border-slate-300 dark:border-slate-700 flex flex-col justify-between hover:border-blue-500/50 transition-all">
              <div>
                <div class="flex items-center gap-2 mb-2">
                  ...
                  <h3 class="font-bold">Butuh Backend Developer?</h3>
                </div>
